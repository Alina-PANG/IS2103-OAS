...
public class DataInitializationSessionBean {
    ...
    private void initializeCustomer() {
        try {
            ...
            AuctionEntity ae1 = auctionEntityController.createNewAuction(new AuctionEntity(formatter.parse("16:34:59 18/11/2017"), formatter.parse("16:36:22 12/12/2017"), new BigDecimal(77), "Totoro", "Cute Totoro!"));
            AuctionEntity ae2 = auctionEntityController.createNewAuction(new AuctionEntity(formatter.parse("23:59:59 18/11/2017"), formatter.parse("23:59:59 20/12/2018"), new BigDecimal(10), "Cup", "Drink Water"));
