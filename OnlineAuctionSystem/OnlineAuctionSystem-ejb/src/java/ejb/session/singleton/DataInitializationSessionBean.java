...
public class DataInitializationSessionBean {
    ...
    private void initializeCustomer() {
        try {
            ...
            bidEntityController.createNewBid(new BidEntity(new BigDecimal(7)), c2.getId(), ae1.getId());
            bidEntityController.createNewBid(new BidEntity(new BigDecimal(5)), c.getId(), ae2.getId());
